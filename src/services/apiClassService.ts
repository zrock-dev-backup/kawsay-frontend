...
export const createClass = async (data: CreateOrUpdateClassRequest): Promise<Class> => {
...
export const updateClass = async (id: number, data: CreateOrUpdateClassRequest): Promise<Class> => {
